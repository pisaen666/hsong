...
// ไฟล์อื่นที่เว็บใช้
["styles.css", "line_oa_qr.png", "promptpay_qr.png", "qrcode_hsong.png"].forEach(f => { if (fs.existsSync(path.join(root, f))) fs.copyFileSync(path.join(root, f), path.join(pub, f)); });
