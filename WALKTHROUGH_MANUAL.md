...
## 8. ระบบแผงค้าเรียกไรเดอร์ส่งของด่วน & ไทม์ไลน์ติดตามสถานะสด (v=9.8)
...
### 2. ไทม์ไลน์ความคืบหน้า 4 สเต็ป (Visual Progress Stepped Timeline):
* `1. เข้าฮับ` (เมื่อร้านค้าโอนค่าส่งแล้ว ส่งงานเข้าสู่คิวฮับทันที)
* `2. ไรเดอร์รับงาน` (เมื่อฮับจัดสรรงานหรือไรเดอร์กดรับงาน)
* `3. รับของที่แผง` (ไรเดอร์เดินทางมาถึงหน้าแผงค้าและรับมอบถุงของสด)
* `4. ส่งถึงลูกค้า` (ไรเดอร์นำส่งถึงบ้านลูกค้าสำเร็จ ยืนยันพิกัด GPS)
* แสดงเวลาประมาณการ (ETA) สอดคล้องกับแต่ละสเต็ป

### 3. เครื่องมือเสริมความสะดวกร้านค้า (Merchant Toolset):
* **🟢 แชร์ LINE ลูกค้า:** แตะปุ่มเดียว ส่งข้อความและลิงก์ติดตามไรเดอร์แบบสดเข้า LINE ให้ลูกค้าปลายทาง
* **📞 โทรหาไรเดอร์ / 💬 แชทไรเดอร์:** สื่อสารสองทางตรงระหว่างแผงค้ากับไรเดอร์
* **📡 ดูเรดาร์สด:** เปิดหน้าจอแผนที่ติดตามพิกัด GPS ไรเดอร์บนท้องถนนแบบสด
* **🖨️ สลิป 80mm:** พิมพ์ใบส่งของขนาดกะทัดรัดสำหรับแปะหน้าถุงสินค้า
* **📸 ดูรูปหลักฐาน:** แสดงรูปถ่ายหลักฐานส่งมอบหน้าบ้านลูกค้าเมื่อสถานะส่งสำเร็จ
* **🚫 ขอยกเลิกเรียกไรเดอร์:** สำหรับกรณีลูกค้าเปลี่ยนใจกระทันหันก่อนไรเดอร์เดินทางมารับของ
* **📑 Multi-Order Selector:** แถบสลับดูงานที่กำลังวิ่งอยู่ทั้งหมดของแผงค้าได้พร้อมกันหลายออเดอร์
