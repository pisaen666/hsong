...
### 3. ปุ่มระบบส่วนหัว (Top Navigation Actions):
* **`🗑️ ล้างออเดอร์` (`clearAllTestData`):** ล้างออเดอร์ทดสอบทั้งหมด รวมถึง Express Orders และคืนค่าคิวเป็น 0 ทันที
* **`🔄 ซิงค์สด` (`syncLatestOrderFromCloud`):** ดึงข้อมูลออเดอร์ล่าสุดทั้งจากคลาวด์และหน่วยความจำในเครื่องมาอัปเดตหน้าจอทันที
