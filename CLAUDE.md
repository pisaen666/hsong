...
## 🧱 5e. Stored-XSS defence (code `app.js?v=10.30_xss_guard`; committed locally, see status in section 6)
...
- (Fixed in code 2026-09-21, section 5e; PRODUCTION only after the owner says push) Stored XSS: attacker text in database records could run code in customer / admin / hub browsers.
